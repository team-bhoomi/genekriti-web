...
const navigationMenuTriggerStyle = cva(
    "group inline-flex items-center gap-3 rounded-l-xl bg-transparent w-full h-[55px] pl-1 pr-3 py-2 font-medium transition duration-75 ease-in-out hover:bg-accent hover:duration-50 focus:bg-accent focus:outline-none disabled:pointer-events-none disabled:opacity-50 hover:before:w-5 hover:before:h-5 hover:before:bg-transparent hover:before:absolute hover:before:-top-5 hover:before:right-0 hover:before:rounded-ee-full hover:before:shadow-[5px_5px_0px_5px_#f4f4f5] hover:before:transition hover:before:duration-75 hover:after:ease-in-out hover:after:w-5 hover:after:h-5 hover:after:bg-transparent hover:after:absolute hover:after:-bottom-5 hover:after:right-0 hover:after:rounded-se-full hover:after:shadow-[5px_-5px_0px_5px_#f4f4f5] hover:after:transition hover:after:duration-75 hover:after:ease-in-out"
);
