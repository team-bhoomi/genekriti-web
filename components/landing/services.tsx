            ...
            <div className="flex flex-col gap-20">
                <div className="flex items-center justify-between gap-10 bg-[#fada5e] rounded-xl p-10">
                    ...
                    <div className="w-full h-[500px] bg-[#faf0e6] rounded-md flex flex-col items-center gap-10 p-10">
                        ...
                        <div className={`text-xl p-4 pt-0`}>
                            ReKriti is dedicated to revolutionizing the way we
                            think about waste. With ReKriti, we believe that
                            every discarded item has the potential to be
                            transformed into something beautiful, useful,
                            and sustainable. <br />
                            <br />
                            ...
                            <ul className="list-disc">
                                ...
                                <li>
                                    AI suggests DIY projects & home décor ideas
                                </li>
                                <li>
                ...
                <div className="flex items-center justify-between gap-10 bg-[#006a4e] rounded-xl p-10">
                    <div className="w-full h-[500px] bg-[#faf0e6] rounded-md flex flex-col items-center gap-10 p-10">
                        ...
                        <div className={`text-xl p-4 pt-0`}>
                            ...
                            eco-friendly products that are good for you and the
                            planet. With every purchase, you're supporting
                            ethical practices and making a positive impact on
                            the environment.
                            <br />
                            <br />
                ...
                <div className="flex items-center justify-between gap-10 bg-[#fada5e] rounded-xl p-10">
                    ...
                    <div className="w-full h-[500px] bg-[#faf0e6] rounded-md flex flex-col items-center gap-10 p-10">
                        ...
                        <div className={`text-xl p-4 pt-0`}>
                            Challenge yourself with our interactive quizzes on
                            sustainability, eco-friendly living, and
                            environmental conservation. Put your knowledge to
                            the test and earn rewards for your efforts.
                            <br />
                            <br />
                            ...
                            <ul className="list-disc">
                                ...
                                <li>
                                    Unlock exclusive benefits within GeneKriti
                                </li>
                ...
                <div className="flex items-center justify-between gap-10 bg-[#006a4e] rounded-xl p-10">
                    <div className="w-full h-[500px] bg-[#faf0e6] rounded-md flex flex-col items-center gap-10 p-10">
                        ...
                        <div className={`text-xl p-4 pt-0`}>
                            Looking to connect with like-minded individuals and
                            organizations? Browse through our curated list of
                            upcoming events focused on environmental
                            ...
                            <ul className="list-disc">
                                ...
                                <li>Connect, learn, and make a difference!</li>
                            </ul>
                        </div>
                    </div>
                    <div className="w-full h-[500px] rounded-md flex items-end overflow-hidden">
