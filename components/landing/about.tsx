    ...
    return (
        ...
        >
            <div className="flex flex-col justify-center items-end w-full">
                <div className="w-[900px] h-[275px] flex items-center justify-center rounded-lg overflow-hidden">
                    <img
                        src="/images/landing/hero-banner2.jpg"
                        className="w-full object-cover"
                    />
                </div>
                <div className="text-8xl font-bold mt-[-60px] w-full text-[#cb4154] about--heading">
                    About
                </div>
            </div>
            <div className="border-y-2 border-[#cb4154] w-full flex gap-10 p-4">
                <div className="w-[300px] min-w-[300px] h-[500px] flex items-center justify-center rounded-xl overflow-hidden">
                    <img
                ...
                <div className="w-full p-10 flex flex-col gap-4 bg-[#006a4e] text-white about--bg">
                    ...
                    >
                        ...
                        greener and more sustainable future. Join our vibrant
                        community and unlock a world of features designed to
                        inspire and empower you
                    </div>

                    <div className="about--tagline bg-[#faf0e6] text-xl font-semibold text-[#006a4e] p-6 mt-10">
                        GeneKriti is more than just an app; it's a community.
                        Join us today and be the change you want to
                        see in the world!
                    </div>
                </div>
            </div>
